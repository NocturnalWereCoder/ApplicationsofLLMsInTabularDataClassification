...
def load_arff_with_headers(file_path):
    """
    ...
    # Decode byte strings for nominal/string values
...
if __name__ == "__main__":
    # Example usage
    name = "waveform"  # base name for files
    file_path = name + ".arff"
    
    df = load_arff_with_headers(file_path)

    print("DataFrame loaded with original headers:")
    print(df.head(10))  # Show first 10 rows to help decide how many rows to drop
    print(df.info())
